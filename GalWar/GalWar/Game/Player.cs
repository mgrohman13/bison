...
namespace GalWar
{
    ...
    public class Player
    {
        ...
        public void MarkObsolete(IEventHandler handler, ShipDesign obsoleteDesign)
        {
            ...
            var colonies = new Dictionary<Colony, Tuple<BuildShip, int, int, double, Buildable, Buildable>>();
            foreach (Colony colony in this.colonies)
            ...
            Game.PushUndoCommand(new Game.UndoCommand<ShipDesign, Dictionary<Colony, Tuple<BuildShip, int, int, double, Buildable, Buildable>>, bool>(
                     new Game.UndoMethod<ShipDesign, Dictionary<Colony, Tuple<BuildShip, int, int, double, Buildable, Buildable>>, bool>(UndoMarkObsolete),
                     obsoleteDesign, colonies, researchFocus));
        }
        private Tile UndoMarkObsolete(ShipDesign obsoleteDesign, Dictionary<Colony, Tuple<BuildShip, int, int, double, Buildable, Buildable>> colonies, bool researchFocus)
        {
            AssertException.Assert(!this.designs.Contains(obsoleteDesign));
            AssertException.Assert(obsoleteDesign != null);
