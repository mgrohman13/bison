...
namespace ClassLibrary1
{
    internal static class ResearchUpgValues
    {
        ...
        private static readonly IReadOnlyDictionary<UpgType, UpgParam> UpgParams = new Dictionary<UpgType, UpgParam>() {
            ...
            { UpgType.TurretAttack, new(10, 0.65, 1.69) },
            { UpgType.TurretLaserAttack, new(6, 0.68, 1.75) },
            { UpgType.TurretExplosivesAttack, new(11, 0.62, 1.65) },
            { UpgType.TurretDefense, new(12, 0.55, 1.20) },
            { UpgType.TurretShieldDefense, new(7, 0.52, 1.25) },
            { UpgType.TurretArmorDefense, new(9, 0.58, 1.15) },
