...
namespace MattUtil
{
	//public class EnumFlags : ICollection<int>, IEnumerable<int>, ICollection, IEnumerable
	//{
	//    EnumFlags<int> inner;

	//    public EnumFlags() { inner = new EnumFlags<int>(); }
	//    public EnumFlags(EnumFlags<int> value) { inner = new EnumFlags<int>(value); }
	//    public EnumFlags(int value) { inner = new EnumFlags<int>(value); }
	//    public EnumFlags(T value) { inner = new EnumFlags<int>(value); }
