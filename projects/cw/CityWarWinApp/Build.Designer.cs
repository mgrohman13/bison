namespace CityWarWinApp
{
    partial class Build
    {
        ...
        private void InitializeComponent()
        {
			...
			this.sbHor = new System.Windows.Forms.HScrollBar();
			this.sbVer = new System.Windows.Forms.VScrollBar();
			...
			this.label6.Tag = "header";
			this.label6.Text = "Regen";
			// 
			// label5
			// 
			...
			this.label11.Size = new System.Drawing.Size(406, 18);
			this.label11.TabIndex = 43;
			this.label11.Tag = "header";
			...
			// sbHor
			// 
			this.sbHor.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.sbHor.LargeChange = 60;
			this.sbHor.Location = new System.Drawing.Point(0, 84);
			this.sbHor.Maximum = 60;
			this.sbHor.Name = "sbHor";
			this.sbHor.Size = new System.Drawing.Size(1292, 16);
			this.sbHor.SmallChange = 13;
			this.sbHor.TabIndex = 54;
			this.sbHor.Scroll += new System.Windows.Forms.ScrollEventHandler(this.sbHor_Scroll);
			// 
			// sbVer
			// 
			this.sbVer.Dock = System.Windows.Forms.DockStyle.Right;
			this.sbVer.LargeChange = 60;
			this.sbVer.Location = new System.Drawing.Point(1276, 0);
			this.sbVer.Maximum = 60;
			this.sbVer.Name = "sbVer";
			this.sbVer.Size = new System.Drawing.Size(16, 84);
			this.sbVer.SmallChange = 13;
			this.sbVer.TabIndex = 55;
			this.sbVer.Scroll += new System.Windows.Forms.ScrollEventHandler(this.sbVer_Scroll);
			// 
			// lblPpl
			// 
			...
			this.ClientSize = new System.Drawing.Size(1292, 100);
			this.Controls.Add(this.lblPpl);
			this.Controls.Add(this.sbVer);
			this.Controls.Add(this.sbHor);
        ...
        private System.Windows.Forms.HScrollBar sbHor;
        private System.Windows.Forms.VScrollBar sbVer;
